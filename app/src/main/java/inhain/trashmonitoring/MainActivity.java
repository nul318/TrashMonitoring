...
//        list_component.add(new TrashCan("a","b",0,"#f5ae98"));
        list_component.add(new TrashCan(0, "서울 고시텔", "20m 이내", 50, "#FF313131", getResources().getDrawable(R.drawable.myprogressbar), 37.393164, 126.933717));
        list_component.add(new TrashCan(1, "관악 실버케어", "100m 이내", 60, "#FF507B8E", getResources().getDrawable(R.drawable.myprogressbar2), 37.392464, 126.932727));
        list_component.add(new TrashCan(2, "럭키빌 고시원", "10m 이내", 70, "#FF5A8674", getResources().getDrawable(R.drawable.myprogressbar3), 37.391114, 126.931715));
        list_component.add(new TrashCan(3, "휴 레지던스", "50m 이내", 90, "#FF93675A", getResources().getDrawable(R.drawable.myprogressbar4), 37.359124, 126.932757));


        list_component.add(new TrashCan(5, "중동 미리내마을", "50m 이내", 20, "#FF507B8E", getResources().getDrawable(R.drawable.myprogressbar2), 37.394114, 126.938113));

        list_component.add(new TrashCan(4, "신 연수역", "20m 이내", 10, "#FF313131", getResources().getDrawable(R.drawable.myprogressbar), 37.392134, 126.918727));
        list_component.add(new TrashCan(6, "안양 삼성레미안", "10m 이내", 30, "#FF5A8674", getResources().getDrawable(R.drawable.myprogressbar3), 37.391144, 126.928717));
        list_component.add(new TrashCan(7, "소정 주택", "30m 이내", 40, "#FF93675A", getResources().getDrawable(R.drawable.myprogressbar4), 37.359164, 126.931327));
...
//            imgButton.setOnClickListener(Buttonhandler);
            ...
            Button trash_btn = (Button) convertView.findViewById(R.id.detail);

            trash_btn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(MainActivity.this, MapViewDialog.class);
                    intent.putExtra("address",components_list.get(position).address);
                    intent.putExtra("location",components_list.get(position).location);
                    intent.putExtra("percent",components_list.get(position).percent);
                    intent.putExtra("x",components_list.get(position).locationX);
                    intent.putExtra("y",components_list.get(position).locationY);
